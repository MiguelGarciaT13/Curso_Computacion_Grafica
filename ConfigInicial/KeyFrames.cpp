...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "SkyBox Miguel", nullptr, nullptr);
	...
	glGenBuffers(1, &VBO);
	glGenBuffers(1, &EBO); // Genera un EBO (Element Buffer Object)
	...
	glBufferData(GL_ELEMENT_ARRAY_BUFFER, sizeof(indices), indices, GL_STATIC_DRAW);// Carga los datos de los índices en el EBO
